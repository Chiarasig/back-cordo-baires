...
function getEmailBody(email,code,host) { //defino una funcion para definir el cuerpo del mail (template)
...
const accountVerificationEmail = async (emailNewUser,codeCrypto) => {
    ...
    const mailOptions = { //defino las opciones del correo
        ...
        to: emailNewUser, //hacia quien
        subject: 'Verify your new account in Amazing Events', //asunto del mail
        html: getEmailBody(emailNewUser,codeCrypto,BACK_URL) //template
    }
